...
class PunjabiSongs : AppCompatActivity() {
    private lateinit var database: DatabaseReference
    private lateinit var songAdapter: adapterPunjabi
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView = findViewById<RecyclerView>(R.id.rvpunjabiSongList)
        recyclerView.layoutManager = LinearLayoutManager(this)
        songList = mutableListOf()
        songAdapter = adapterPunjabi(songList)
    ...
    private fun fetchBollywoodSongs() {
        database.child("categories").child("punjabi").addValueEventListener(object :
            ValueEventListener {
